    ...
    superherostring += `
        <div class="superhero">
            <div class="superhero_img">
              <img class="img" src="${superhero.images.md}" alt=""/>
            </div>
            <div class="superhero_details">
              <h1 class="superhero_name">${superhero.name}</h1>
              <div class="body_stats">
                  <h3>${superhero.appearance.gender} ${superhero.appearance.height[0]}" ${superhero.appearance.height[1]}</h3>
              </div>
              <div class="powerstats">
                  <div>
                      <p>Intelligence: ${superhero.powerstats.intelligence}</p>
                      <div class="power_bg">
                          <div class="power_fg" style='width: ${superhero.powerstats.intelligence}%'></div>
                      </div>
                  </div>
                  ...
                  <div>
                      ...
                      <div class="power_bg">
                          <div class="power_fg" style='width: ${superhero.powerstats.power}%'></div>
                      </div>
                  </div>
                  ...
                  <div>
                      ...
                      <div class="power_bg">
                          <div class="power_fg" style='width: ${superhero.powerstats.speed}%'></div>
                      </div>
                  </div>
                  ...
                  <div>
                      ...
                      <div class="power_bg">
                          <div class="power_fg" style='width: ${superhero.powerstats.strength}%'></div>
                      </div>
                  </div>
                  ...
                  <div>
                      ...
                      <div class="power_bg">
                          <div class="power_fg" style='width: ${superhero.powerstats.durability}%'></div>
                      </div>
                  </div>
                  ...
                  <div>
                      ...
                      <div class="power_bg">
                          <div class="power_fg" style='width: ${superhero.powerstats.combat}%'></div>
                      </div>
                  </div>                
            </div>
        </div>
...
{/* <p>strength: ${superheros.powerstats.strength}</p>
                <p>speed: ${superheros.powerstats.speed}</p>
                <p>durability : ${superheros.powerstats.durability}</p>
                <p>power : ${superheros.powerstats.power}</p>
                <p>combat : ${superheros.powerstats.combat}</p> */}